...
# 定义可能用到的符号变量
a1,a2,a3,d1,d4,d5,d6=sy.symbols('a1 a2 a3 d1 d4 d5 d6')
...
# T=T.subs([(sy.sin(q1),s1),(sy.sin(q2),s2),(sy.sin(q2+q3),s23),(sy.sin(q2+q3+q4),s234),(sy.sin(q5),s5),(sy.sin(q6),s6), \
#           (sy.cos(q1),c1),(sy.cos(q2),c2),(sy.cos(q2+q3),c23),(sy.cos(q2+q3+q4),c234),(sy.cos(q5),c5),(sy.cos(q6),c6)])
