...
q2_lim=[-10,+500];%q2为线位移，单位mm
q3_lim=[-120,+120];%q3为角位移，单位°
q4_lim=[-90,+90];%q4为角位移，单位°
q5_lim=[-90,+90];%q5为角位移，单位°
q6_lim=[-90,+90];%q6为角位移，单位°

%工作空间计算
space(n,q1_lim,q2_lim,q3_lim,q4_lim,q5_lim,q6_lim);

%工作空间绘制
function space(n,q1_lim,q2_lim,q3_lim,q4_lim,q5_lim,q6_lim)
...
q5=q5_lim(1)+diff(q5_lim)*rand(n,1);%q5在正负限位范围内进行蒙特卡洛随机采样
q6=q6_lim(1)+diff(q6_lim)*rand(n,1);%q6在正负限位范围内进行蒙特卡洛随机采样
q=[q1,q2,q3,q4,q5,q6];
