...
'''
# 定义DH参数
theta=[-sy.pi/2, 0, -sy.pi/2, 0]
d=[0, 0, 0, 0]
a=[0, a1, a2, a3]
alpha=[-sy.pi/2, sy.pi, 0, 0]
...
s1,s2,s23,s234=sy.symbols('s1 s2 s23 s234')
c1,c2,c23,c234=sy.symbols('c1 c2 c23 c234')
T=T.subs([(sy.sin(q1),s1),(sy.sin(q2),s2),(sy.sin(q2+q3),s23),(sy.sin(q2+q3+q4),s234), \
           (sy.cos(q1),c1),(sy.cos(q2),c2),(sy.cos(q2+q3),c23),(sy.cos(q2+q3+q4),c234)])
...
'''
A1=mdh_matrix(alpha[0], a[0], d[0]+q[0], theta[0])
...
T_1=sy.simplify((A1**-1)*T*(A6**-1)*(A5**-1))
T_2=sy.simplify(A2*A3*A4)
