...
q3_lim=[-10,+500];%q3为线位移，单位mm
q4_lim=[-10,+500];%q4为线位移，单位mm
q5_lim=[-180,+180];%q5为角位移，单位°

%工作空间计算
space(n,q1_lim,q2_lim,q3_lim,q4_lim,q5_lim);

%工作空间绘制
function space(n,q1_lim,q2_lim,q3_lim,q4_lim,q5_lim)
